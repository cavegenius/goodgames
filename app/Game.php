...
class Game extends Model {
    ...
    public function allGamesForListByUser( $user, $list='all', $sortCol='name', $sortOrder='asc') {
       if( $list == 'all' ){
    ...
    public function filteredList( $user, $list='all', $sortCol='name', $sortOrder='asc', $filters=[], $search = '' ) {
        ...
        if( $list == 'all' ){
            $games = DB::table('games')
                ...
                ->whereIn('genre',count($filters['genre'])>0 ? $filters['genre'] : ["Adventure", "Board Game", "Fighting", "Indie", "Music", "Not Set", "Other", "Quiz/Trivia", "Role-playing", "Shooter", "Simulator", "Strategy", "Tactical"])
